...
class CifarResNeXt(nn.Module):
  ...
  """
  def __init__(self, block, depth, cardinality, base_width, num_classes, first_channel=3):
    ...
    self.conv_1_3x3 = nn.Conv2d(first_channel, 64, 3, 1, 1, bias=False)
...
def resnext29_16_64(num_classes=10, dataset='cifar10'):
  ...
  model = CifarResNeXt(ResNeXtBottleneck, 29, 16, 64, num_classes, first_channel)
  return model

def resnext29_8_64(num_classes=10, dataset='cifar10'):
  ...
  """
  first_channel = 1 if dataset == 'mnist' else 3
  model = CifarResNeXt(ResNeXtBottleneck, 29, 8, 64, num_classes, first_channel)
  return model
