...
def preprocess_image(pil_im, mean=[0.485, 0.456, 0.406], var=[0.229, 0.224, 0.225], resize_im=True):
    """
...
def recreate_image(im_as_var, mean=[0.485, 0.456, 0.406], var=[0.229, 0.224, 0.225]):
    """
